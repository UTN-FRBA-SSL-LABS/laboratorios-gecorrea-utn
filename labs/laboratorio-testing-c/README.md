...
> R:Accede al atributo cantidad del carrito por medio del puntero para inicializar el carrito en 0, es decir, carrito vacío.
...
> R:falla, se estaba esperando el valor de 700 y se obtuvo 350.
...
> R:24, era un acumulador de precios unitarios del carrito.

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R:multiplicar el precio unitario por la cantidad de items del mismo tipo existentes.
...
> R:falla, [FAIL] carrito_agregar(&c,p) => esperado 0, obtenido 1  (linea 64)
